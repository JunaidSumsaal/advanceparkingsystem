  ...
  return (
    <Box p={4}>
      <Stack spacing={4} as={Container} maxW={"3xl"} textAlign={"center"}>
        <Heading fontSize={"3xl"} color={"primary.400"}>
          Explore What{" "}
          <span className="text-gray-700">AdvanceParkingSystem Offers</span>
        </Heading>
        <Text color={"gray.600"} fontSize={"xl"}>
          From real-time spot tracking to smart pricing and instant alerts,
          AdvanceParkingSystem empowers you with the tools to make parking
          effortless. Designed for reliability and flexibility, it’s your
          ultimate parking companion.
        </Text>
      </Stack>
